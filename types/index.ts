...
export const ROLE_PERMISSIONS = {
  admin: {
    ...
    canViewCosts: true, canViewAudit: true, canViewReports: true, canManageUsers: true,
    canViewQMS: true, canManageQMS: true,
    canViewFinanzas: true, canViewTaller: true, canViewWMS: true, canViewProyectos: true,
    canViewComercial: true, canViewDemand: true, canViewSeriales: true, canViewRMA: true,
    canViewBOM: true, canExportData: true,
  },
  vendedor: {
    label: 'Vendedor',
    ...
    canViewCosts: false, canViewAudit: false, canViewReports: true, canManageUsers: false,
    canViewQMS: false, canManageQMS: false,
    canViewFinanzas: false, canViewTaller: false, canViewWMS: false, canViewProyectos: true,
    canViewComercial: true, canViewDemand: false, canViewSeriales: false, canViewRMA: true,
    canViewBOM: false, canExportData: true,
  },
  bodeguero: {
    label: 'Bodeguero',
    ...
    canViewCosts: true, canViewAudit: false, canViewReports: false, canManageUsers: false,
    canViewQMS: true, canManageQMS: false,
    canViewFinanzas: false, canViewTaller: false, canViewWMS: true, canViewProyectos: false,
    canViewComercial: false, canViewDemand: true, canViewSeriales: true, canViewRMA: false,
    canViewBOM: true, canExportData: true,
  },
  operador: {
    label: 'Operador',
    ...
    canViewCosts: true, canViewAudit: false, canViewReports: false, canManageUsers: false,
    canViewQMS: true, canManageQMS: true,
    canViewFinanzas: false, canViewTaller: true, canViewWMS: true, canViewProyectos: true,
    canViewComercial: true, canViewDemand: true, canViewSeriales: true, canViewRMA: true,
    canViewBOM: true, canExportData: true,
  },
} as const;
...
export type TabType = 'dashboard' | 'executive' | 'pricing' | 'replenishment' | 'stock' | 'movimientos' | 'analytics' | 'reportes' | 'costos' | 'auditoria' | 'compras' | 'ventas' | 'integraciones' | 'almacenes' | 'seriales' | 'trazabilidad' | 'rma' | 'bom' | 'ensamblajes' | 'proyectos' | 'comercial' | 'finanzas' | 'taller' | 'qms' | 'wms' | 'demand' | 'chat' | 'aprobaciones' | 'facturacion' | 'tickets' | 'garantias' | 'clientes_360' | 'rrhh';
