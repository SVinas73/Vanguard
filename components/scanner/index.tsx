  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 w-14 h-14 bg-slate-900 border border-slate-800 rounded-full shadow-lg flex items-center justify-center text-slate-200 hover:scale-110 transition-transform z-40"
      >
        <Barcode size={24} />
      </button>
