...
const resources = {
  es: {
    translation: {
      ...
      nav: { main: 'Principal', dashboard: 'Dashboard', executive: 'Vista Ejecutiva', stock: 'Stock', movements: 'Transacciones de Movimientos', operations: 'Operaciones', purchases: 'Compras', sales: 'Ventas', warehouses: 'Almacenes', analysis: 'Análisis', analytics: 'Analytics IA', reports: 'Reportes', costs: 'Costos', config: 'Configuración', integrations: 'Integraciones', audit: 'Auditoría', controlTracking: 'Control & Seguimiento', postSales: 'Post-venta', people: 'Personal', approvals: 'Aprobaciones', invoicing: 'Facturación electrónica' },
      executive: {
