...
// COPIA ESTO Y REEMPLAZA EL SAMPLE_PRODUCTS EN lib/constants.ts

export const SAMPLE_PRODUCTS: Product[] = [
  // ========== IMAGEN 1 - STOCKS ==========
  { codigo: 'A4T', descripcion: 'ACEITE 4T X 4LT 20W50 X 4LT', precio: 1254.4, categoria: 'Estación de Servicio', stock: 8, stockMinimo: 5 },
  { codigo: 'A2T', descripcion: 'ACEITE 2T X 1LT', precio: 378.69, categoria: 'Estación de Servicio', stock: 2, stockMinimo: 5 },
  { codigo: 'A15W', descripcion: 'ACEITE 15W40 TURBO DIESEL X 4LT', precio: 1044, categoria: 'Estación de Servicio', stock: 3, stockMinimo: 5 },
  { codigo: 'ALUB', descripcion: 'ACEITE LUBAN 30PLUS X 4LT', precio: 1198.2, categoria: 'Estación de Servicio', stock: 10, stockMinimo: 5 },
  { codigo: 'LHID4', descripcion: 'LIQUIDO HIDRAULICO X 4LT', precio: 1021.8, categoria: 'Ferretería', stock: 4, stockMinimo: 5 },
  { codigo: 'ASN', descripcion: 'AEROSOL SPRAY NEGRO', precio: 0, categoria: 'Ferretería', stock: 6, stockMinimo: 5 },
  { codigo: 'ASA', descripcion: 'AEROSOL SPRAY AMARILLO', precio: 0, categoria: 'Ferretería', stock: 6, stockMinimo: 5 },
  { codigo: 'SJUN', descripcion: 'SELLA JUNTA 368gr Permatex', precio: 1352.46, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  { codigo: 'POXI', descripcion: 'POXIPOL', precio: 0, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  { codigo: 'TRAB', descripcion: 'TRABASIL', precio: 1114.75, categoria: 'Ferretería', stock: 2, stockMinimo: 5 },
  { codigo: 'TEF', descripcion: 'TEFLON', precio: 0, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  { codigo: 'WD40', descripcion: 'WD40', precio: 0, categoria: 'Ferretería', stock: 17, stockMinimo: 5 },
  { codigo: 'FERRETERIA', descripcion: 'GRASA X1KG', precio: 0, categoria: 'Estación de Servicio', stock: 0, stockMinimo: 5 },
  { codigo: 'TRAPOS', descripcion: 'TRAPOS (BOLSA)', precio: 1057.38, categoria: 'Ferretería', stock: 10, stockMinimo: 5 },
  { codigo: 'HLIJA', descripcion: 'HOJAS DE LIJA', precio: 0, categoria: 'Ferretería', stock: 20, stockMinimo: 5 },
  { codigo: 'CINAISL', descripcion: 'CINTA AISLADORA', precio: 0, categoria: 'Ferretería', stock: 6, stockMinimo: 5 },
  ...
  { codigo: 'SJUN2', descripcion: 'SELLA JUNTA', precio: 975.41, categoria: 'Ferretería', stock: 0, stockMinimo: 5 },
  ...
  { codigo: 'PINC', descripcion: 'PINCELES (X UNIDAD)', precio: 0, categoria: 'Edintor', stock: 3, stockMinimo: 5 },
  { codigo: 'DEST', descripcion: 'DESTORNILLADORES TORX', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'HTRIN', descripcion: 'REPUESTO TRINCHETA HKNSB112 (X UNIDAD)', precio: 0, categoria: 'Edintor', stock: 15, stockMinimo: 5 },
  { codigo: 'TCONTR', descripcion: 'TERMO CONTRAIBLE 4MM (X METRO)', precio: 23.77, categoria: 'Ferretería', stock: 11, stockMinimo: 5 },
  { codigo: 'NYL', descripcion: 'NYLON DE MANO (UNIDAD)', precio: 0, categoria: 'Embalaje', stock: 16, stockMinimo: 5 },
  { codigo: 'CINEMP', descripcion: 'CINTA DE EMPAQUE (UNIDAD)', precio: 0, categoria: 'Embalaje', stock: 97, stockMinimo: 5 },
  { codigo: 'CINFRAG', descripcion: 'CINTA FRAGIL', precio: 0, categoria: 'Embalaje', stock: 13, stockMinimo: 5 },
  { codigo: 'POLIPRO', descripcion: 'BOLSA POLIPROPILENO X PAQUETE', precio: 0, categoria: 'Embalaje', stock: 1, stockMinimo: 5 },
  { codigo: 'BOLBASU', descripcion: 'BOLSA BASURA', precio: 0, categoria: 'Embalaje', stock: 23, stockMinimo: 5 },
  { codigo: 'GRAMP', descripcion: 'GRAMPAS X CAJA', precio: 0, categoria: 'Papelería', stock: 0, stockMinimo: 5 },
  { codigo: 'BOLGOM', descripcion: 'BOLSA DE GOMITAS X200GR', precio: 81.15, categoria: 'Papelería', stock: 3, stockMinimo: 5 },
  ...
  { codigo: 'MARPIZ', descripcion: 'MARCADORES PIZARRON', precio: 0, categoria: 'Papelería', stock: 2, stockMinimo: 5 },
  ...
  { codigo: 'LAP', descripcion: 'LAPICERAS', precio: 0, categoria: 'Papelería', stock: 3, stockMinimo: 5 },
  { codigo: 'RES', descripcion: 'RESALTADOR (FLUOR)', precio: 20, categoria: 'Papelería', stock: 6, stockMinimo: 5 },
  { codigo: 'TRIN', descripcion: 'TRINCHETA', precio: 0, categoria: 'Oficina', stock: 7, stockMinimo: 5 },
  { codigo: 'TONXER', descripcion: 'TONER XEROX B230', precio: 0, categoria: 'Oficina', stock: 0, stockMinimo: 5 },
  { codigo: 'TONWX', descripcion: 'TONER WX-3330', precio: 0, categoria: 'Oficina', stock: 1, stockMinimo: 5 },
  { codigo: 'TONMS', descripcion: 'TONER MS521', precio: 0, categoria: 'Oficina', stock: 0, stockMinimo: 5 },
  ...
  { codigo: 'GORROCV', descripcion: 'GORRO CV', precio: 0, categoria: 'Edintor', stock: 22, stockMinimo: 5 },
  { codigo: 'LAPINGCO', descripcion: 'LAPICERA INGCO', precio: 0, categoria: 'Edintor', stock: 55, stockMinimo: 5 },

  // ========== IMAGEN 2 - STOCKS ==========
  { codigo: 'NEMPAG', descripcion: 'NYLON EMPAQUE GRANDE', precio: 0, categoria: 'Ferretería', stock: 40, stockMinimo: 5 },
  ...
  { codigo: 'HSDX10100', descripcion: 'TORX T10 INM', precio: 0, categoria: 'Edintor', stock: 16, stockMinimo: 5 },
  { codigo: 'HPTW200N1', descripcion: 'TORQUIMETRO INGCO', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'ASG', descripcion: 'AEROSOL GRIS', precio: 0, categoria: 'Ferretería', stock: 2, stockMinimo: 5 },
  { codigo: 'SDBIM11PH263', descripcion: 'SET PUNTAS PH LARGAS', precio: 0, categoria: 'Edintor', stock: 5, stockMinimo: 5 },
  { codigo: 'HCT4001', descripcion: 'PRECINTO 40CM', precio: 0, categoria: 'Ferretería', stock: 0, stockMinimo: 5 },
  { codigo: 'HCT2001', descripcion: 'PRECINTO 20CM', precio: 0, categoria: 'Ferretería', stock: 0, stockMinimo: 5 },
  { codigo: 'WGX1K03', descripcion: 'GOTITA WADFOW', precio: 0, categoria: 'Ferretería', stock: 4, stockMinimo: 5 },
  ...
  { codigo: 'ASB', descripcion: 'AEROSOL BLANCO', precio: 0, categoria: 'Ferretería', stock: 0, stockMinimo: 5 },
  { codigo: 'TECL', descripcion: 'TECLADO', precio: 0, categoria: 'Oficina', stock: 1, stockMinimo: 5 },
  { codigo: 'TCONTR3', descripcion: 'TERMOCONTRAIBLE 3MM (X METRO)', precio: 27.87, categoria: 'Ferretería', stock: 24, stockMinimo: 5 },
  { codigo: 'REMEL', descripcion: 'REMERA TALLE L', precio: 0, categoria: 'Edintor', stock: 8, stockMinimo: 5 },
  { codigo: 'GRALIQUI', descripcion: 'GRASA LIQUIDA SEALFIX', precio: 237.7, categoria: 'Ferretería', stock: 0, stockMinimo: 5 },
  { codigo: 'PRUSSAZU', descripcion: 'AZUL DE PRUSSIAN REVELADOR', precio: 237.7, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  ...
  { codigo: 'CINTWAD', descripcion: 'CINTERO WADFOW', precio: 0, categoria: 'Edintor', stock: 2, stockMinimo: 5 },
  { codigo: 'SOLEST', descripcion: 'SOLDADOR DE ESTAÑO', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  ...
  { codigo: 'LIMCARB', descripcion: 'LIMPIA CARBURADOR', precio: 122, categoria: 'Edintor', stock: 2, stockMinimo: 5 },
  { codigo: 'CUAIN', descripcion: 'CUADERNO INGCO', precio: 0, categoria: 'Edintor', stock: 25, stockMinimo: 5 },
  { codigo: 'REMEXL', descripcion: 'REMERA TALLE XL', precio: 0, categoria: 'Edintor', stock: 24, stockMinimo: 5 },
  ...
  { codigo: 'WAK1502', descripcion: 'LAPICERA WADFOW', precio: 0, categoria: 'Edintor', stock: 12, stockMinimo: 5 },
  ...
  { codigo: 'AMN1231', descripcion: 'DADO IMPACTO 12 P/TORNILLADORA', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'WBV1A08', descripcion: 'MORSA 8"', precio: 4336.07, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'SDBIM11PH223', descripcion: 'PUNTA PHILLIPS CORTA', precio: 0, categoria: 'Edintor', stock: 10, stockMinimo: 5 },
  { codigo: 'HWSP102429', descripcion: 'PELACABLE', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'GUANTES', descripcion: 'GUANTES NITRILO N', precio: 2.25, categoria: 'Edintor', stock: 900, stockMinimo: 50 },
  ...
  { codigo: 'SI00108', descripcion: 'SOLDADOR ESTAÑO 100W', precio: 0, categoria: 'Ferretería', stock: 2, stockMinimo: 5 },
  { codigo: 'HRUH8808', descripcion: 'MACETA DE GOMA', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'SDBIM21HL133', descripcion: 'PUNTA PHILLIPS-PALETA', precio: 0, categoria: 'Edintor', stock: 20, stockMinimo: 5 },
  { codigo: 'MTEMP', descripcion: 'MEDIDOR DE TEMP PARA CAMIONETA', precio: 647.54, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'GO', descripcion: 'GASOIL', precio: 50.14, categoria: 'Estación de Servicio', stock: 0, stockMinimo: 5 },
  ...
  { codigo: 'WXP1302', descripcion: 'CINTA TEFLON 3/4', precio: 0, categoria: 'Edintor', stock: 18, stockMinimo: 5 },
  ...
  { codigo: 'GASSOP', descripcion: 'GAS PARA SOPLETE', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'BARSIL', descripcion: 'BARRA DE SILICONA CALIENTE', precio: 0, categoria: 'Ferretería', stock: 36, stockMinimo: 5 },
  { codigo: 'WHU2905', descripcion: 'ABRAZADERA 19 - 44', precio: 0, categoria: 'Edintor', stock: 18, stockMinimo: 5 },
  { codigo: 'WPN4H45', descripcion: 'CINTA SEGURIDAD', precio: 0, categoria: 'Edintor', stock: 1, stockMinimo: 5 },
  ...
  { codigo: 'MESMER', descripcion: 'MANGO ESMERILADOR', precio: 713.11, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  { codigo: 'PESM', descripcion: 'PASTA ESMERIL', precio: 0, categoria: 'Ferretería', stock: 1, stockMinimo: 5 },
  ...
  { codigo: 'HSTH81500', descripcion: 'MACETA INGCO 1500G', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'HMHS81001', descripcion: 'MARTILLO INGCO 100G', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'WPB1915', descripcion: 'PINCEL WADFOW 1,5"', precio: 0, categoria: 'Edintor', stock: 2, stockMinimo: 5 },
  { codigo: 'HKPHS0401B', descripcion: 'JUEGO DE PINCHOS', precio: 0, categoria: 'Edintor', stock: 0, stockMinimo: 5 },
  { codigo: 'SUP95', descripcion: 'NAFTA SUPER 95 X 1LT', precio: 78.54, categoria: 'Estación de Servicio', stock: 10, stockMinimo: 5 },
